...
// Para configurar o idioma, na raiz do projeto altere o archivo config.json
...
export async function before(m, {conn, participants}) {
  ...
  if (chat.detect2 && m.messageStubType == 26) {
    ...
    // Enviar solo el mensaje de apertura/cierre
    await conn.sendMessage(m.chat, {text: accion}, {quoted: fkontak2});
  }
} /* Cierre del comando */
